...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(
        ...
        System.out.println("[REGISTRATION_START] Received request");
        System.out.println("[REGISTRATION_DATA] userJson: " + userJson);
        if (file != null) {
            System.out.println("[REGISTRATION_FILE] filename: " + file.getOriginalFilename());
        }

        try {
            com.fasterxml.jackson.databind.ObjectMapper mapper = new com.fasterxml.jackson.databind.ObjectMapper();
            com.farmerretailer.dto.UserRegistrationDTO registrationDTO = mapper.readValue(userJson, com.farmerretailer.dto.UserRegistrationDTO.class);

            if (registrationDTO == null || registrationDTO.getEmail() == null) {
                return ResponseEntity.badRequest().body("Error: Email is required in the payload!");
            }
            ...
            System.out.println("[REGISTRATION_SUCCESS] Email: " + user.getEmail());
            
            return ResponseEntity.ok("User registered successfully. Please wait for admin approval.");

        } catch (Exception e) {
            System.err.println("[REGISTRATION_FAILURE] Reason: " + e.getMessage());
            e.printStackTrace();
