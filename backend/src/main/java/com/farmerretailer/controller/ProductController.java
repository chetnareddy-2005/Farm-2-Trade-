...
public class ProductController {
    ...
    public ResponseEntity<?> getMyProducts(org.springframework.security.core.Authentication authentication) {
        if (authentication == null) {
            System.err.println("DEBUG: getMyProducts - Authentication is NULL!");
