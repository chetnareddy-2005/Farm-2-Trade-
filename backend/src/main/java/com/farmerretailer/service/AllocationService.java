...
public class AllocationService {
    ...
    public Map<String, Object> calculateAllocationScore(Driver driver, String source, String destination, String weatherCondition) {
        ...
        result.put("driverName", driver.getUser() != null ? driver.getUser().getFullName() : "Registered Transporter");
        ...
        result.put("vehicle", driver.getVehicleType() != null ? driver.getVehicleType() : "Standard Vehicle");
        result.put("isRecommended", totalScore > 65);
        result.put("badge", totalScore > 80 ? "🏆 Top Choice" : totalScore > 60 ? "✅ Verified Driver" : "🔍 Standard");
    ...
    public List<Map<String, Object>> getOptimizedAssignments(String destination) {
        ...
        // We now show all registered drivers, prioritizing available ones in scoring
        List<Driver> allDrivers = transportService.getAllTransporters();
